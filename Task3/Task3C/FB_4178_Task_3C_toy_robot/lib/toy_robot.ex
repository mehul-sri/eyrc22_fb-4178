defmodule ToyRobot do
  ...
  @directions_to_the_back %{north: :south, east: :west, south: :north, west: :east}
  @doc """
  Rotates the robot to the backside (U turn)
  """
  def u_turn(%ToyRobot.Position{facing: facing} = robot) do
    %ToyRobot.Position{robot | facing: @directions_to_the_back[facing]}
  end
